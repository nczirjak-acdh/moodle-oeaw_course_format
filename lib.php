...
class format_oeaw_cf extends format_base {
    ...
    protected function __construct($format, $courseid) {
        ...
        if (empty($section)) {
            if (isset($USER->display[$courseid]) && ($PAGE->pagetype == 'course-view-oeaw_cf' || $PAGE->pagetype == 'course-view')
    ...
    public function get_default_section_name($section) {
        return get_string('sectionname', 'format_oeaw_cf') . ' ' . $section->section;
    }
    ...
    public function supports_ajax() {
        ...
        $disable_ajax = isset($USER->oeaw_cf_da[$course->id]) ? $USER->oeaw_cf_da[$course->id] : false;
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            ...
            $courseformatoptionsedit = array(
                ...
                'hidetabsbar' => array(
                    'label' => get_string('hidetabsbar', 'format_oeaw_cf'),
                    'help' => 'hidetabsbar',
                    'help_component' => 'format_oeaw_cf',
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(
                ...
                'coursedisplay' => array(
                    'label' => new lang_string('coursedisplay', 'format_oeaw_cf'),
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(
                            COURSE_DISPLAY_SINGLEPAGE => new lang_string('coursedisplay_single', 'format_oeaw_cf'),
                            COURSE_DISPLAY_MULTIPAGE => new lang_string('coursedisplay_multi', 'format_oeaw_cf')
                        )
                    ),
                    'help' => 'coursedisplay',
                    'help_component' => 'format_oeaw_cf',
                ...
                'templatetopic' => array(
                    'label' => new lang_string('templatetopic', 'format_oeaw_cf'),
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(
                            self::TEMPLATETOPIC_NOT => new lang_string('templetetopic_not', 'format_oeaw_cf'),
                            self::TEMPLATETOPIC_SINGLE => new lang_string('templetetopic_single', 'format_oeaw_cf'),
                            self::TEMPLATETOPIC_LIST => new lang_string('templetetopic_list', 'format_oeaw_cf')
                        )
                    ),
                    'help' => 'templatetopic',
                    'help_component' => 'format_oeaw_cf',
                ...
                'templatetopic_icons' => array(
                    'label' => get_string('templatetopic_icons', 'format_oeaw_cf'),
     ...
     *
     * In case if course format was changed to 'oeaw_cf', we try to copy special options from the previous format.
        ...
        if ($foreditform) {
            $sectionformatoptionsedit = array(
                'level' => array(
                    'default' => 0,
                    'type' => PARAM_INT,
                    'label' => get_string('level', 'format_oeaw_cf'),
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(
                            0 => get_string('asprincipal', 'format_oeaw_cf'),
                            1 => get_string('aschild', 'format_oeaw_cf')
                        )
                    ),
                    'help' => 'level',
                    'help_component' => 'format_oeaw_cf',
                ...
                'firsttabtext' => array(
                    'default' => get_string('index', 'format_oeaw_cf'),
                    'type' => PARAM_TEXT,
                    'label' => get_string('firsttabtext', 'format_oeaw_cf'),
                    'help' => 'firsttabtext',
                    'help_component' => 'format_oeaw_cf',
                ),
                'fontcolor' => array(
                    'default' => '',
                    'type' => PARAM_RAW,
                    'label' => get_string('fontcolor', 'format_oeaw_cf'),
                    'help' => 'fontcolor',
                    'help_component' => 'format_oeaw_cf',
                ),
                'bgcolor' => array(
                    'default' => '',
                    'type' => PARAM_RAW,
                    'label' => get_string('bgcolor', 'format_oeaw_cf'),
                    'help' => 'bgcolor',
                    'help_component' => 'format_oeaw_cf',
                ),
                'cssstyles' => array(
                    'default' => '',
                    'type' => PARAM_RAW,
                    'label' => get_string('cssstyles', 'format_oeaw_cf'),
                    'help' => 'cssstyles',
                    'help_component' => 'format_oeaw_cf',
                )
            );
    ...
    /*public function course_content_header() {
        return new format_oeaw_cf_header();
    }*/
}

class format_oeaw_cf_replace_regularexpression {
...
class format_oeaw_cf_header implements renderable {}
