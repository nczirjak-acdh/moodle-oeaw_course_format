...
/**
 * Strings for component 'format_oeaw_cf', language 'en', branch 'MOODLE_24_STABLE'
 *
 * @since 2.4
...
$string['pluginname'] = 'Oeaw course format';
$string['page-course-view-topics'] = 'Any course main page in oeaw_cf format';
$string['page-course-view-topics-x'] = 'Any course page in oeaw_cf format';
